  ...
  return (
    <MainLayout>
      <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
             <WidgetCard title="Linked Accounts" className="h-full">
                <div className="space-y-4">
                   ...
                   <Button variant="ghost" className="w-full border-dashed border border-border hover:border-[var(--cs-cyan)] text-xs h-10">
                      + Add New Method
                   </Button>
                </div>
             </WidgetCard>
        ...
        {/* Recent Transactions */}
        <WidgetCard title="Recent Transactions" headerAction={<Button variant="ghost" size="sm" className="text-xs">View All</Button>}>
