...
import { Radio, Check, Sword } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video rounded-lg overflow-hidden bg-twitch-surface ring-1 ring-border group-hover:ring-[var(--cs-green)] group-hover:shadow-[0_0_20px_rgba(57,255,20,0.2)] transition-all duration-300">
        ...
        {/* Dares Badge - NEW for Darer niche */}
        {channel.isPartner && (
          <div className="absolute top-2 right-2 flex items-center gap-1 px-1.5 py-0.5 bg-[var(--cs-yellow)] text-black text-[10px] font-black uppercase rounded shadow-[0_0_10px_var(--cs-yellow)]">
